...
public partial class Doc : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand com = new SqlCommand("select * from tbdoc where email='" + lblname.Text + "'", con);
        ...
        {   
            ...
            com = new SqlCommand("select * from tbdoc where name='" + lblname.Text + "'", con);
    ...
    {
        Session.Clear();
        Response.Redirect("Signdoc.aspx");
